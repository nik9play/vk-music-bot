  ...
  execute: async function(message) {
    const embed = {
      ...
      fields: [
        ...
        {
          name: "`play`, `p`",
          value: "Добавить в очереди трек/треки. Принимает название трека, ID трека, ссылку на плейлист или на пользователя",
          inline: true
        },
        {
          name: "`stop`, `s`",
        ...
        },
        {
          ...
          value: "Перемешать очередь. **Требуется Премиум**",
          inline: true
        },
        {
          name: ":star: `24/7`",
          value: "Режим 24/7. Бот не выйдет из канала после окончания очереди, паузы и выхода всех людей из канала. **Требуется Премиум**",
          inline: true
        },
        {
          name: "`loop`, `l`",
