...
export default new Command({
  ...
  execute: async ({ client, guild, respond }) => {
    ...
    if (!premium)
      info += `Вы можете приобрести **Премиум**, задонатив 15₽ или больше [здесь](https://vk.com/app6887721_-197274096)
...
Все деньги идут на развитие и поддержание бота. Вы можете пользоваться всеми остальными функциями бота абсолютно бесплатно.`
    ...
    const embed = {
      color: 0x5181b8,
      title: `Статус **Премиума**:  ${
        premium ? '<:yes2:835498559805063169>' : '<:no2:835498572916195368>'
      }`,
      description: info
    }
